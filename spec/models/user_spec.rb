...
RSpec.describe User, :type => :model do
  ...
  # tests sets the user email to invalid or blank and then test to see @user object is invalid
  ...
  #testing to make sure duplicate email address are not submitted
  ...
  #Don't want password to be blank 
  ...
  #checks that a password is not too short
